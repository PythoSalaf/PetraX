...
const OilCard: React.FC<OilCardProps> = ({
  ...
  return (
    <div className="w-full border border-gray-800 shadow rounded-2xl hover:border-purple-500 transition-all duration-300 bg-gray-900/50 backdrop-blur-sm">
      ...
      <div className="w-[94%] mx-auto py-3">
        ...
        <div className="space-y-2 text-sm text-gray-300">
          <div className="flex items-center gap-x-1.5">
            ...
            <span className="truncate" title={seller}>
              {seller}
            </span>
          </div>
          ...
          <div className="flex items-center gap-x-1.5">
            ...
            <span>{typeof quantity === 'string' ? quantity : formatOilQuantity(quantity)}</span>
          </div>
